...
public class ArrayStringMinMaxServiceTest {
    ...
    @Test
    public void testMinWithMixedLengths() throws ArrayException {
    ...
    @Test
    public void testMaxWithMixedLengths() throws ArrayException {
    ...
    @Test
    public void testMinMaxWithEqualLengths() throws ArrayException {
    ...
    @Test
    public void testMinMaxWithSingleElement() throws ArrayException {
    ...
    @Test
    public void testMinMaxWithEmptyArrayThrowsException() {
        String[] input = {};
    ...
    @Test
    public void testMinMaxWithAllInvalidTokensThrowsException() {
        String[] input = {"!!!", "", null};
        assertThrows(ArrayException.class, () ->
                ArrayEntity.newBuilder()
                        .setData(input)
